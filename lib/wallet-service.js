        ...
        const orderDoc = {
          ...
          messages: [
            ...
            buildOrderMessage({
              id: `msg_${now}_sys_s`,
              role: 'seller',
              text: `A new order has been created. Please wait for the buyer to complete the payment. If the buyer does not pay in time, the order will be automatically cancelled.`,
              createdAt: now,
              isSystem: true
            })
          ]
