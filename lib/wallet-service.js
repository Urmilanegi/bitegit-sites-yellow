              ...
              messages:
                targetStatus === ORDER_STATUS.EXPIRED
                  ...
                  : buildOrderMessage({
                      ...
                      sender: isSystem ? 'System' : actorName,
                      senderRole: isSystem ? 'system' : transition.actorRole || '',
                      text: cancelReason
                        ? `${actorName} cancelled the order. Reason: ${cancelReason}. Reserved ad liquidity was restored.`
                        : `${actorName} cancelled the order. Reserved ad liquidity was restored.`,
                      createdAt: now,
                      isSystem
                    }),
              statusHistory: createOrderStatusHistoryEntry({
